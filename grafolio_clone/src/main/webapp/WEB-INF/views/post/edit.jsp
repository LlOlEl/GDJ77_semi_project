...
<jsp:include page="../layout/header.jsp">
 ...
 <link rel="stylesheet" href="${contextPath}/resources/css/postwrite.css?dt=${dt}">
  ...
  <div class="container">
    <h1 class="title mb-4">포스트 편집화면</h1>
    ...
    <form id="frm-post-modify"
      ...
      <div class="mb-3">
        <span class="form-label">작성일자</span>
        <span>${post.createDt}</span>
      </div>
      
      <div class="mb-3">
        <span class="form-label">최종수정일</span>
      ...
      <div>
        ...
        <a href="${contextPath}/post/list.page"><button class="btn btn-warning" type="button">수정취소</button></a>
      </div>
    </form>
  </div>
