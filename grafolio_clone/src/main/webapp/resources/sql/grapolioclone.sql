...
CREATE TABLE USER_T (
  ...
  /* 미니 프로필 사진 정보 */      MINI_PROFILE_PICTURE_PATH VARCHAR2(400 BYTE) NULL,
  /* 메인 프로필 사진 정보 */      MAIN_PROFILE_PICTURE_PATH VARCHAR2(400 BYTE) NULL,
  /* 프로필 설명 */                DESCRIPT VARCHAR2(200 BYTE) NULL,
  /* 프로필 태그 */                PROFILE_CATEGORY VARCHAR2(200 BYTE) NULL,
...
/*
-- PW가 수정된 경우에만 PW_MODIFY_DT를 UPDATE 해준다.
CREATE OR REPLACE TRIGGER UPDATE_PW_MODIFY_DT_TRIGGER
BEFORE UPDATE OF PW ON USER_T
FOR EACH ROW
BEGIN IF :OLD.PW != :NEW.PW THEN
         :NEW.PW_MODIFY_DT := CURRENT_DATE;
      END IF;
END;
*/